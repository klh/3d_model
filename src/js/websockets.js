		...
		if (ws == null) {
			...
			ws.onmessage = function(evt){
				...
				if (data.commandId == "get_initial_images") {
					...
					console.log('Update 3D model event received');
					update3DModel(data);
				}
			};
		}
		...
		function updateContours(data) {
			switch(data.updateElementId){
				...
				case "EHorizontalLongAxisView":
					horizontalLongAxisContourContext.clearRect(0, 0, horizontalLongAxisContour.width, horizontalLongAxisContour.height);
			...
			switch(data.updateElementId){
				...
				case "EVerticalLongAxisView":
					...
					image.onload = function() {
						verticalLongAxisContext.drawImage(image, 0, 0, image.width, image.height,
							0, 0, verticalLongAxisCanvas.width, verticalLongAxisCanvas.height);
					}
					break;
				case "EHorizontalLongAxisView":
					...
					image.onload = function() {
						horizontalLongAxisContext.drawImage(image, 0, 0, image.width, image.height,
							0, 0, horizontalLongAxisCanvas.width, horizontalLongAxisCanvas.height);
					}
					break;
				case "EShortAxisView":
					...
					image.onload = function() {
						shortAxisContext.drawImage(image, 0, 0, image.width, image.height,
							0, 0, shortAxisCanvas.width, shortAxisCanvas.height);
					}
					break;
				/*case "EPolarMap":
